classdef Building < blockages.Blockage
    ...
    methods
        function obj = Building(floorPlan, height, loss, name)
            ...
            obj = obj@blockages.Blockage(xCenter, yCenter, r);
            ...
            for iCorner = 1:size(floorPlan,2)-1
                ...
                % update WallList
                obj.wallList = [obj.wallList, blockages.WallBlockage([lowerLeft, lowerRight, upperRight, upperLeft], loss)];
            end

            % Create and add ceiling to WallList
            zCeiling	= height*ones(1, size(floorPlan,2));
            ceiling     = [obj.floorPlan; zCeiling];
            obj.wallList = [obj.wallList, blockages.WallBlockage(ceiling, loss)];
        end
