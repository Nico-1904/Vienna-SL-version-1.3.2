classdef UniformCluster < networkGeometry.ClusteredDistribution
    ...
    %   elements are uniformaly distributed for round or rectangular
    %   regions. The number of points in each cluster can be set to a fixed
    %   value or is calculated through a poisson random variable with the
    %   set density (homogenous poisson point process within cluster).
    %
