classdef UniformDistribution < networkGeometry.NodeDistribution
    ...
    %   Creates the positions of network elements in the given ROI
    %   according to a homogenous poisson point process.
    %   This means that the number of points to be distrubuted is a poisson
    %   random variable with the parameter lambda being the product of the
    %   given density and the area of the ROI. This number of points is
    %   then uniformly distributed in the ROI.
    %   It is also possible to set the number of points to distribute in
